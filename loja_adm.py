...
def dados_registrados(arquivo_dados):
    ...
    # Se o tipo não for um dicionario
        ...
        # Se não conseguir transformar em dicionario, pede ao usuario a confirmacao do nome do arquivo
            ...
            print('O arquivo com o cadastro dos adms está no formado errado.')
            arquivo_dados = input('Por favor, digite o nome do arquivo com os cadastros em forma de dicionário: ')
...
def recupera_estoque(arquivo_dados):
    ...
    # nao forem dicionarios com as chaves "Produto", "Preco", "Em estoque"
        ...
        print('O arquivo com o cadastro do estoque está no formado errado.')
...
def cadastrar_adm(arquivo_com_cadastros):
    ...
    while not usuario:
        # Pede o usuario
        usuario = input('Digite o nome do usuário (0 (zero) para cancelar): ')
        ...
        # Se ja tem o usuario cadastrado, pede para cadastrar outro nome
            ...
            print('Já existe um cadastro com esse nome de usuário. Por favor, escolha outro.')
            usuario = False
    ...
    while not senha_igual:
        ...
        senha_verificacao = input('Repita a senha para verificação: ')
...
def remover_adm(arquivo_com_cadastros):
    ...
    while not usuario:
        ...
        # Se nao acha o usuario dado, pede para tentar de novo
            ...
            print('Usuário não identificado. Por favor, digite de novo.')
            print()
            usuario = False
        else:
            print(f'\nConfirma a remoção de {usuario} dos administradores cadastrados?')
...
def login(adms_cadastrados):
    ...
    """
    # Aviso sobre login
    print('É necessario que seja feito o login')

    # Pede e confere o usuario
    usuario = False
    while not usuario:
        usuario = input('Digite o nome do usuário (0 (zero) para sair): ')
    ...
    tentativas = 3
    while not senha:
        senha = input('Digite a senha do usuário ("sair" para sair): ')
        ...
        # Se nao sair, confere a senha do usuario informado
            ...
            if bc.hashpw(senha, senha_salva) == senha_salva:
                ...
                if tentativas > 0:
                    print('A senha digitada está incorreta. Por favor, tente de novo.')
...
def cadastrar_produto(arquivo_estoque):
    ...
    while repetir:
        ...
        if produto in produtos_cadastrados:
            ...
            print(f'Os produtos cadastrados são: {", ".join(produtos_cadastrados)}')
        else:
            ...
            while True:
                ...
                try:
                    ...
                    print('O preco informado deve ser um número positivo.')
            ...
            while True:
                ...
                try:
                    ...
                    print('A quantidade informada deve ser um número inteiro igual ou maior que zero.')
...
def remover_produto(arquivo_estoque):
    ...
    while True:
        ...
        num_produto = input('\nDigite o número do produto a ser removido: (0 (zero) para cancelar) ')
        ...
        if produto_valido:
            ...
            if num_produto == 0:
                ...
                print(f'\nConfirma a remoção de {estoque[num_produto - 1]["Produto"]} do estoque?')
...
def alterar_preco_ou_quantidade(arquivo_estoque, preco_ou_quantidade='quantidade'):
    ...
    while repetir:
        ...
        if preco_ou_quantidade == 'quantidade':
            num_produto = input('\nDigite o número do produto para alterar a quantidade (0 (zero) para cancelar): ')
        else:  # Preco
            num_produto = input('\nDigite o número do produto para alterar o preco (0 (zero) para cancelar): ')
            ...
            # Pedindo o novo preco ou nova quantidade
                ...
                while True:
                    ...
                    try:
                        ...
                        if preco_ou_quantidade == 'quantidade':
                            print(f'Digite um número válido (inteiro não-negativo).')
                        else:
                            print(f'Digite um número válido (não-negativo).')
                    else:
                        break
...
if __name__ == '__main__':
    ...
    print('\n' * 1, 'RESULTADO:', sep='\n')
    print(f'Usuário cadastrado: {adm_cadastrado}')
    print(f'Dicionário de adms registrados: {dicionario_adms_cadastrados}')
    ...
    print('\n' * 1, 'RESULTADO:', sep='\n')
    print(f'Usuário removido: {adm_removido}')
    print(f'Dicionário de adms registrados: {dicionario_adms_cadastrados}')
    aux.separar_comandos_print()
