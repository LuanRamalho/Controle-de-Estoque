...
def adicionar_produto_carrinho(estoque, carrinho):
    ...
    while repetir:
        ...
        num_produto_para_add = input('Digite o número do produto a ser '
...
def remover_produto_carrinho(carrinho):
    ...
    while repetir:
        if not aux.checa_vazio(carrinho):
            ...
            num_produto_remover = input('Digite o número do produto a ser '
...
def alterar_quantidade_carrinho(estoque, carrinho, adicionando=False):
    ...
    while repetir:
        ...
        if not adicionando:
            ...
            num_produto_para_alterar = input('Digite o número do produto a ser '
